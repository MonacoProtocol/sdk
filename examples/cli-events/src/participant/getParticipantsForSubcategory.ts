import { Participants, findCategoryPda, findSubcategoryPda } from "@monaco-protocol/event-client";
...
const args = getProcessArgs(["categoryCode", "subcategoryCode"], "npm run getParticipantsForSubcategory");
